  ...
  class Addresses extends Payload {
    ...
    public function toBinary () : string {
      ...
      foreach ($this->Addresses as $Address)
        if ($Version >= 31402)
          $Buffer .= pack ('VPa16n', $Address->getTimestamp (), $Address->getServices (), Events\Socket::ip6toBinary ($Address->getIPAddress ()), $Address->getPort ());
        else
          $Buffer .= pack ('Pa16n', $Address->getServices (), Events\Socket::ip6toBinary ($Address->getIPAddress ()), $Address->getPort ());
